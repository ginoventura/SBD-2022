...
---------------------------------------------------------------------------------------------------------------------------------
-- LA FK A TIPOS_HABITACIONES NO SE PUEDE APLICAR PORQUE LA TABLA TIPOS_HABITACIONES TODAVÍA NO FUE CREADA
---------------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------
-- NRO_DETALLE_RESERVA SMALLINT??
-- LA FK A RESERVAS NO PUEDE SER CREADA PORQUE LA TABLA RESERVAS AÚN NO EXISTE
---------------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------
-- FALTA LA REFERENCIA A CLIENTES
---------------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------
-- LA FK A CLIENTES NO PUEDE SER IMPLEMENTADA PORQUE NO EXISTE TODAVÍA LA TABLA CLIENTES
---------------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------
-- LAS FKS NO PUEDEN SER CREADAS PORQUE NO EXISTEN LAS TABLAS REFERENCIADAS
-- LA FECHA DE SALIDA NO ES OBLIGATORIA
---------------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------
-- NRO_RESERVA Y NRO_DETALLE_RESERVA NO SON OBLIGATORIOS, SOLO SE INFORMAN SI HAY UNA RESERVA ASOCIADA
-- FECHA_HORA_SALIDA, NRO_FACTURA E IMPORTE_FACTURA NO SON OBLIGATORIOS Y SON TODOS NULOS O TODOS NO NULOS
-- NRO_RECIBO NO ES OBLIGATORIO
-- LA FK A RESERVAS ES REDUNDANTE
-- LA FK A DETALLE_RESERVAS TIENE LAS COLUMNAS EN EL ORDEN INVERTIDO
---------------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------
-- NO ESTÁ BIEN CONTEMPLADO EL CASO DE FECHA_HORA_SALIDA NULA
---------------------------------------------------------------------------------------------------------------------------------
