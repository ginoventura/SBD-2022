...
/*
EJERCICIOS:
   a. Ha surgido un nuevo requerimiento en el sistema de gestión de solicitudes de servicios: Teniendo en cuenta que los responsables de 
      servicios pueden cambiar con el tiempo, y que se necesita saber quien era el responsable del servicio para cada solicitud,
	  se requiere agregar como información obligatoria de la solicitud, quien es el responsable del servicio.
	  Además, se necesita modificar la regla de integridad sobre el registro de horas trabajadas. También será obligatorio cargarlas para
	  las órdenes de trabajo que estén en ejecución, permitiéndose en este caso que la cantidad de horas pueda ser cero.
   ...
   b. Debe migrar los datos actuales agregando la información a las solicitudes y de las órdenes de trabajo. En el caso de las solicitudes, 
      suponer que los responsables de los servicios, no han cambiado y que son los actuales. En el caso de las órdenes de trabajo, como no 
      se tiene información de horas trabajadas para las órdenes que están en ejecución, se les deberá cargar el valor 0.
   ...
   c. Mostrar para cada empleado la cantidad de órdenes de trabajo finalizadas, pendientes y en ejecución.
