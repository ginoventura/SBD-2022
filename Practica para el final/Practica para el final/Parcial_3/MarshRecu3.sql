...
-- SE ESTÁN CONTROLANDO TODOS LOS GRUPOS Y NO SOLO A LOS QUE SE LES HA INSERTADO ALUMNOS
...
-- SI NO TIENE ALUMNOS INSCRIPTOS NO FUNCIONA
-- SE DEBIERA CONTAR SOLO LOS CONFIRMADOS
-- NO SE CONSIDERÓ QUE PODÍA HABER MÁS DE UN HORARIO EN EL MISMO DÍA (VER MODELO)
